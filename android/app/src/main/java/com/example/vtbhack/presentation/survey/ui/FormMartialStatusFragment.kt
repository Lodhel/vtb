...
import com.example.vtbhack.databinding.FragmentFormMartialStatusBinding
...
class FormMartialStatusFragment : Fragment(R.layout.fragment_form_martial_status) {
    private lateinit var binding: FragmentFormMartialStatusBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentFormMartialStatusBinding.bind(view)
    ...
    private fun initialiseUIElements() {
        binding.next.setOnClickListener {
            surveyViewModel.survey.marital_status = binding.married.isChecked
            setCurrentFragment(FormChildrenFragment())
        }
